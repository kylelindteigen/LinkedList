...
class ListInterface
{
   ...
   /** Inserts an entry into this list at a given position.
    ...
    @throw  PrecondViolatedExcep if insertion cannot be performed. */
		...
		virtual void insert(int newPosition, const T& newEntry) throw(PrecondViolatedExcep) = 0;
   ...
   /** Gets the entry at the given position in this list.
    ...
    @throw  PrecondViolatedExcep if no such entry exists. */
		...
		virtual T getEntry(int position) const throw(PrecondViolatedExcep) = 0;
   ...
   /** Replaces the entry at the given position in this list.
    ...
    @throw  PrecondViolatedExcep if no such entry exists. */
		...
		virtual void setEntry(int position, const T& newEntry) throw(PrecondViolatedExcep) = 0;
